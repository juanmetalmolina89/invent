...
import gov.mads.invent.ive.fachada.impl.DivipolaFAC;
...
public class DivipolaSERV { 
	...
	@JWT
	public Response insertar(Insertar_3_OE objetoEntrada) {
		DivipolaFAC fac = new DivipolaFAC();
	...
	@Produces({MediaType.APPLICATION_JSON})
	@JWT
	public Response eliminar(Eliminar_3_OE objetoEntrada) {
		DivipolaFAC fac = new DivipolaFAC();
	...
	@Produces({MediaType.APPLICATION_JSON})
	@JWT
	public Response actualizar(Actualizar_3_OE objetoEntrada) {
		DivipolaFAC fac = new DivipolaFAC();
	...
	@Produces({MediaType.APPLICATION_JSON})
	@JWT
	public Response consultarPorFiltro(ConsultarPorFiltro_3_OE objetoEntrada) {
		DivipolaFAC fac = new DivipolaFAC();
