...
import gov.mads.invent.ive.fachada.impl.InventContaminaFAC;
 ...
 * @author Ivan Chacon
*/
@Path("/inventContamina")
public class InventContaminaSERV { 
	...
	@JWT
	public Response insertar(Insertar_4_OE objetoEntrada) {
		InventContaminaFAC fac = new InventContaminaFAC();
	...
	@Produces({MediaType.APPLICATION_JSON})
	@JWT
	public Response eliminar(Eliminar_4_OE objetoEntrada) {
		InventContaminaFAC fac = new InventContaminaFAC();
	...
	@Produces({MediaType.APPLICATION_JSON})
	@JWT
	public Response actualizar(Actualizar_4_OE objetoEntrada) {
		InventContaminaFAC fac = new InventContaminaFAC();
	...
	@Produces({MediaType.APPLICATION_JSON})
	@JWT
	public Response consultarPorFiltro(ConsultarPorFiltro_4_OE objetoEntrada) {
		InventContaminaFAC fac = new InventContaminaFAC();
