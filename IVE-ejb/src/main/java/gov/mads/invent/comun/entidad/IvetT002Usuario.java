 ...
 */
@Entity
@Table(name = "IVET_T002_USUARIO")
@NamedQueries({@NamedQuery(name = "IvetT002Usuario.findAll", query = "SELECT i FROM IvetT002Usuario i")})
public class IvetT002Usuario implements Serializable {
    ...
    @JoinColumn(name = "A002LOCALIZACION", referencedColumnName = "A105CODIGO")
    @ManyToOne(optional = false)
    private PartT105Divipola a002localizacion;

    public IvetT002Usuario() {

    }

    public IvetT002Usuario(Integer a002codigo) {

        this.a002codigo = a002codigo;
    }

    public IvetT002Usuario(Integer a002codigo, String a002nombre, String a002apellido, String a002documento, String a002direccioncorresp, String a002correoelectronico, String a002usuario, String a002contrasena, Character a002estadousuario, Character a002estadoregistro, int a002usuariocreacion) {
    ...
    public PartT105Divipola getA002localizacion() {

        return a002localizacion;
    }

    public void setA002localizacion(PartT105Divipola a002localizacion) {

        this.a002localizacion = a002localizacion;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof IvetT002Usuario)) {
            return false;
        }
        IvetT002Usuario other = (IvetT002Usuario) object;
    ...
    public String toString() {
        ...
        return "gov.mads.invent.comun.entidad.IvetT002Usuario[ a002codigo=" + a002codigo + " ]";
    }
