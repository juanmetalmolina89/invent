create or replace package body PK_T011_UNIDADMEDIDA is
...
BEGIN
      ...
      p_A011CODIGO := PK_UTL_UTILIDAD.Fn_Obtenerid('T011_UNIDADMEDIDA_SEQ');
      ...
      pk_utl_utilidad.pr_registrardebug (p_niveldebug    => PK_UTL_CONSTANTE.NIVEL_TRACE,
                                         ...
                                         p_descripcion   => 'Entro a Pr_Insertar ' || p_A011UNIDADMEDIDA);

      INSERT INTO IVET_T011_UNIDADMEDIDA(A011CODIGO,
                                        A011UNIDADMEDIDA,
                                        A011ESTADOREGISTRO,
                                        A011FECHACREACION,
                                        A011USUARIOCREACION)
    ...
    pk_utl_utilidad.pr_registrardebug(p_niveldebug    => PK_UTL_CONSTANTE.NIVEL_TRACE,
                                      ...
                                      p_procedimiento => NOMBRE_PROCEDIMIENTO,
                                      p_usuario       => p_idUsuario,
                                      p_descripcion   => 'Salio de Pr_Insertar ' || p_A011UNIDADMEDIDA);
  ...
  PROCEDURE Pr_Eliminar (p_A011CODIGO  IN IVET_T011_UNIDADMEDIDA.A011CODIGO%TYPE,
   ...
   BEGIN
    ...
    pk_utl_utilidad.pr_registrardebug (p_niveldebug    => PK_UTL_CONSTANTE.NIVEL_TRACE,
                                       ...
                                       p_procedimiento => NOMBRE_PROCEDIMIENTO,
                                       p_usuario       => p_idUsuario,
                                       p_descripcion   => 'Entro a Pr_Eliminar ' || p_A011CODIGO);

    
              UPDATE IVET_T011_UNIDADMEDIDA 
    ...
    pk_utl_utilidad.pr_registrardebug(p_niveldebug    => PK_UTL_CONSTANTE.NIVEL_TRACE,
                                      ...
                                      p_procedimiento => NOMBRE_PROCEDIMIENTO,
                                      p_usuario       => p_idUsuario,
                                      p_descripcion   => 'Salio de Pr_Eliminar ' || p_A011CODIGO);
...
PROCEDURE Pr_Actualizar (p_A011CODIGO IN  IVET_T011_UNIDADMEDIDA.A011CODIGO%TYPE,
   ...
   BEGIN
    ...
    pk_utl_utilidad.pr_registrardebug (p_niveldebug    => PK_UTL_CONSTANTE.NIVEL_TRACE,
                                       ...
                                       p_procedimiento => NOMBRE_PROCEDIMIENTO,
                                       p_usuario       => p_idUsuario,
                                       p_descripcion   => 'Entro a Pr_Actualizar ' || p_A011CODIGO);
      ...
      SELECT COUNT(*) 
        INTO numReg 
        FROM IVET_T011_UNIDADMEDIDA 
       WHERE A011CODIGO = p_A011CODIGO 
         AND A011ESTADOREGISTRO = PK_UTL_CONSTANTE.COD_ACTIVO;
      
      IF numReg > 0 THEN
      
         UPDATE IVET_T011_UNIDADMEDIDA SET A011UNIDADMEDIDA=NVL(p_A011UNIDADMEDIDA, A011UNIDADMEDIDA),
                                           A011FECHAMODIFICACION = sysdate,
                                           A011USUARIOMODIFICACION = p_idUsuario 
                                     WHERE A011CODIGO = p_A011CODIGO;
    ...
    pk_utl_utilidad.pr_registrardebug(p_niveldebug    => PK_UTL_CONSTANTE.NIVEL_TRACE,
                                      ...
                                      p_procedimiento => NOMBRE_PROCEDIMIENTO,
                                      p_usuario       => p_idUsuario,
                                      p_descripcion   => 'Salio de Pr_Actualizar ' || p_A011CODIGO);
   ...
   BEGIN
    ...
    pk_utl_utilidad.pr_registrardebug (p_niveldebug    => PK_UTL_CONSTANTE.NIVEL_TRACE,
      ...
      IF p_Filtro IS NULL THEN
         ...
         SELECT * 
           FROM IVET_T011_UNIDADMEDIDA
          WHERE A011ESTADOREGISTRO = PK_UTL_CONSTANTE.COD_ACTIVO;
       ...
       END IF;
         ...
         strSQL := 'SELECT * FROM IVET_T011_UNIDADMEDIDA WHERE ' || p_Filtro ||' AND A003ESTADOREGISTRO ='''
                   || PK_UTL_CONSTANTE.COD_ACTIVO ||''''; 
